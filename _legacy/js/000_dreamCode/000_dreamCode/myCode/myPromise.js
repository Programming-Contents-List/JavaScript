...
const print0 = new Promise((res) => {
  res("res");
})
print0.then(success => { console.log(success) })
print0.then(success => { console.log(success) }, console.log("success"))
...
// printer.then(console.log);//=>res가 출력된다.
